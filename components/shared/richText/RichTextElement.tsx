    ...
    types: {
      ...
      component: ({
        ...
        switch (componentItem.system.type) {
          ...
          case contentTypes.tab_component.codename:
            return (
              <Tabs
                item={componentItem as TabComponent}
              />
            );
          ...
          case contentTypes.embedded_code.codename:
            return (
              <EmbeddedCodeComponent item={componentItem as EmbeddedCode} />
            );
