...
export const Footer: FC<Props> = (props) => {
  ...
  return (
    <footer className='bg-gradient-to-tl from-rose-950 to-manufacturing-dark w-full py-8 text-white'>
      <div className='flex items-center mx-auto max-w-screen-xl px-4'>
        <div className='w-full h-full md:flex justify-between z-40 md:pr-24 xl:pr-12 2xl:pr-0'>
